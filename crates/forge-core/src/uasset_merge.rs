...
use uasset::property::TaggedProperty;
use uasset::structured::{parse_structured_with_uexp, ExportInfo, ImportInfo};
...
fn build_merged_exports(
    base: &uasset::structured::StructuredAsset,
    ours: &uasset::structured::StructuredAsset,
    theirs: &uasset::structured::StructuredAsset,
) -> Vec<MergedExportData> {
    use uasset::property::serialize_tagged_properties;
    use std::collections::BTreeMap;
