...
Forge is licensed under the [Business Source License 1.1](LICENSE).

You may use, modify, and self-host Forge for any purpose — personal,
internal, or commercial — with one exception: you may not offer Forge to
third parties as a hosted or managed service (including any service that
hosts Forge repositories, performs version control operations, or exposes
Forge's APIs on their behalf). Internal use within your organization is
permitted.

There is no automatic conversion to an open-source license. For commercial
licensing that permits hosted or managed service offerings, contact the
author.
